 ...
 */
module gx.ttyx.terminal.terminal;
...
import gx.ttyx.terminal.clipboard;
import gx.ttyx.terminal.context;
import gx.ttyx.terminal.process;
import gx.ttyx.terminal.renderer;
import gx.ttyx.terminal.spawn;
import gx.ttyx.terminal.exvte;
import gx.ttyx.terminal.flatpak;
import gx.ttyx.terminal.layout;
import gx.ttyx.terminal.password;
...
private:
     ...
     * moved to gx.ttyx.terminal.clipboard.ClipboardHandler */
...
private:
    ...
    /* Color state and methods moved to gx.ttyx.terminal.renderer.TerminalRenderer */
     ...
     * getCursorShape) moved to gx.ttyx.terminal.exvte */
...
private:
    ...
    /* getHostShell moved to gx.ttyx.terminal.spawn */
    ...
    /* Flatpak host command functions moved to gx.ttyx.terminal.flatpak */

    /* setProxyEnv moved to gx.ttyx.terminal.spawn */
...
private:
    ...
    /* Badge, margin, color, and draw methods moved to gx.ttyx.terminal.renderer.TerminalRenderer */
...
public:
    ...
    /* Process query logic moved to gx.ttyx.terminal.process.TerminalProcessQuery.
...
/* UnsafePasteDialog moved to gx.ttyx.terminal.clipboard */


/* DnD types, trigger types, and serialization constants moved to gx.ttyx.terminal.types */
/* Terminal state types moved to gx.ttyx.terminal.state */
